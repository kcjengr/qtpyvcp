...
class BaseCanon(QObject):
    ...
    def straight_traverse(self, x, y, z, a, b, c, u, v, w):
        ...
        if not self.first_move:
            ...
            # Suppress only the first discontinuity move, then resume normal rapids.
            self.first_move = False
    ...
    def arc_feed(self, end_x, end_y, center_x, center_y, rot, end_z, a, b, c, u, v, w):
        ...
        if not self.path_initialized:
            # Initial machine position is unknown in preview; seed without creating geometry.
            self.path_initialized = True
            self.first_move = False
