...
class VTKCanon(StatCanon):
    def __init__(self, colors=COLOR_MAP, *args, **kwargs):
        ...
        super().set_g5x_offset(
            self.active_wcs_index + 1,
            g5x[0], g5x[1], g5x[2], g5x[3], g5x[4], g5x[5], g5x[6], g5x[7], g5x[8]
        )
            ...
            if path_actor is not None:
                ...
                for row in data:
                    ...
                    if self._datasource.isMachineFoam():
                        ...
                        # The first traverse in a segment has no provable start point.
