...
project = 'QtPyVCP'
copyright = '2018-2023, Kurt Jacobson.'
...
rst_epilog = '.. |code_version| replace:: ``%s``\n' % version
rst_epilog += '.. |code_release| replace:: ``%s``\n' % release
rst_epilog += '.. |qtpyvcp_deb| replace:: ``python3-qtpyvcp_%s.dev_all.deb``' % release
rst_epilog += '.. |qtpyvcp_deb_link| replace:: ``https://repository.qtpyvcp.com/repo/qtpyvcp-dev/python3-qtpyvcp_%s.dev_all.deb``' % release
