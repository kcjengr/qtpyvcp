...
rst_epilog += '.. |code release| replace:: ``%s``\n' % release
rst_epilog += '.. |qtpyvcp deb| replace:: python3-qtpyvcp_%s.dev_all.deb' % (release)
rst_epilog += '.. |qtpyvcp deb link| replace:: https://repository.qtpyvcp.com/repo/qtpyvcp-dev/python3-qtpyvcp_%s.dev_all.deb' % (release)
