...
"""Main entry point for widgets_test.
...
Example:
    ...
    launch vtk_test by saying::

        $ vtk_test --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='widgets_test',
                          vcp_name='widgets_test',
